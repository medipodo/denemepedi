...
const Dealers = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Satış Noktalarımız</h1>
      ...
      <section className="py-8 bg-white relative z-0">
        <div className="container mx-auto px-4">
                ...
                >
                  <Popup>
                    <div className="min-w-[200px]">
                      ...
                      <p className="text-xs text-gray-500 mb-2">{dealer.type}</p>
                      <p className="text-sm text-gray-600 mb-2">{dealer.address}</p>
                      {dealer.phone && (
                        <a href={`tel:${dealer.phone.replace(/\s/g, '')}`} className="text-sm text-red-600 hover:underline">
                          {dealer.phone}
                        </a>
                      )}
                    </div>
          ...
          <div className="max-w-xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 border rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 text-lg"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900">
              {filteredDealers.length} Satış Noktası Bulundu
            </h2>
          </div>
