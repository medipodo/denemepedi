            ...
            <div className="space-y-4">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-white">
                <picture>
                  ...
                  <img src={productImages[selectedImage]} alt="PediZone Serum" className="w-full aspect-square object-cover" loading="eager" fetchpriority="high" />
                </picture>
              </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-2">
                  Ayak ve Tırnak Bakımı İçin Yoğun Antifungal Destek
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                İnce moleküler yapısı sayesinde <strong>tırnak plağına, tırnak altına ve deri kıvrımlarına</strong> krem formüllere kıyasla çok daha derin nüfuz eder. Bu özelliği ile mantar oluşumuna elverişli nemli ortamın azaltılmasına, cilt ve tırnak yüzeyinin dengelenmesine yardımcı olur.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-lg mb-8">
              <picture>
                <source media="(max-width: 640px)" srcSet="/images/products/serum/before-after-nail.png?w=640&q=75" />
                <source media="(max-width: 1024px)" srcSet="/images/products/serum/before-after-nail.png?w=1024&q=80" />
                <img 
                  src="/images/products/serum/before-after-nail.png" 
