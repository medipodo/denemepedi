...
const Dealers = () => {
  ...
  // Hem bu sayfa hem de Home.jsx otomatik olarak güncellenir.
...
const getTypeColor = (type) => {
  switch(type) {
    ...
    case 'Sağlık Teknikeri': return 'bg-teal-100 text-teal-700';
...
>
  <MapPin className="w-4 h-4 text-white" /> {/* İkon da beyaz */}
  <span className="text-white">Yol Tarifi Al</span> {/* Yazı beyaz */}
</a>
                      </div>
                    </div>
                  </Popup>
